...
def main():
    ...
    lion = Mammal(name="Tyson", animal_id="M001", species="African Lion", age=10, dietary_needs="Raw Meat", fur_colour="Golden")
    parrot = Bird(name="Traitor", animal_id="B001", species="Macaw Parrot", age=3, dietary_needs="Seeds", wing_span=50)
    snake = Reptile(name="Naagin", animal_id="R001", species="King Cobra Snake", age=4, dietary_needs="Rodents", scale_pattern="Diamond")
    ...
    print(f"Enclosure Report {status['enclosure_id']}: Animals: {status['animal_count']}, Cleanliness: {status['cleanliness']}")
